...
import { 
  markAsReadAction, markAllAsReadAction,
...
export default function NotificationsCenterClient({ initialNotifications }: NotificationsCenterClientProps) {
  ...
  const processedNotifications = notifications.filter((n) => {
    ...
    if (filterTab === "inbox" && isArchived) return false;
