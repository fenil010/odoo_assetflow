...
async function main() {
  ...
  const assetsToCreate = [
    ...
    {
      name: "Featherlite Ergonomic Executive Chair",
      categoryId: furnitureCat.id,
      serialNumber: "SN-FTH-ERG201",
    ...
    },
    {
      ...
      serialNumber: "SN-TOY-INC771",
      acquisitionDate: new Date("2025-02-01"),
      acquisitionCost: 1950000.00,
      condition: AssetCondition.NEW,
      status: AssetStatus.AVAILABLE,
    ...
    {
      name: "Creality Ender 5 Plus 3D Printer",
      categoryId: machineryCat.id,
      serialNumber: "SN-CRL-3D400",
    ...
    },
    {
      ...
      categoryId: electronicCat.id,
      serialNumber: "SN-IPD-M2801",
      acquisitionDate: new Date("2025-08-01"),
      acquisitionCost: 89900.00,
      condition: AssetCondition.NEW,
      status: AssetStatus.AVAILABLE,
    ...
    {
      name: "Godrej Electric Height-Adjustable Desk",
      categoryId: furnitureCat.id,
      serialNumber: "SN-GDJ-HT123",
    ...
    },
    {
      ...
      categoryId: electronicCat.id,
      serialNumber: "SN-IPH-15PM9",
      acquisitionDate: new Date("2025-09-20"),
      acquisitionCost: 134900.00,
      condition: AssetCondition.NEW,
      status: AssetStatus.ALLOCATED,
    ...
    },
    {
      ...
      categoryId: electronicCat.id,
      serialNumber: "SN-LNV-E15G4",
      acquisitionDate: new Date("2025-03-10"),
      acquisitionCost: 72000.00,
      condition: AssetCondition.GOOD,
      status: AssetStatus.AVAILABLE,
      location: "Finance Wing",
      isSharedResource: false,
    ...
    {
      name: "Durian Ergo Office Chair",
      categoryId: furnitureCat.id,
      serialNumber: "SN-DUR-ERGO1",
      acquisitionDate: new Date("2024-05-18"),
      acquisitionCost: 16500.00,
      condition: AssetCondition.GOOD,
      status: AssetStatus.AVAILABLE,
      location: "Design Studio - Level 2",
      isSharedResource: false,
    ...
    {
      name: "Sony Alpha ZV-E10 Camera Kit",
      categoryId: electronicCat.id,
      serialNumber: "SN-SON-ZVE10",
      acquisitionDate: new Date("2024-11-05"),
      acquisitionCost: 68000.00,
      condition: AssetCondition.GOOD,
      status: AssetStatus.ALLOCATED,
      location: "Marketing Room 2B",
      isSharedResource: false,
    ...
    {
      name: "Tata Winger Staff Van",
      categoryId: vehicleCat.id,
      serialNumber: "SN-TAT-WNG200",
      acquisitionDate: new Date("2025-01-15"),
      acquisitionCost: 1050000.00,
      condition: AssetCondition.GOOD,
      status: AssetStatus.AVAILABLE,
    ...
    {
      name: "Nilkamal Venice Sectional Sofa",
      categoryId: furnitureCat.id,
      serialNumber: "SN-NIL-VEN-SOF",
    ...
    {
      name: "Godrej Electric Forklift 2T",
      categoryId: machineryCat.id,
      serialNumber: "SN-GDJ-FRK2T",
